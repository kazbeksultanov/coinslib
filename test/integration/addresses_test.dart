...
main() {
  group('bitcoinjs-lib (addresses)', () {
    ...
    test('can generate an address from a SHA256 hash', () {
      final hash = SHA256Digest().process(utf8.encode('correct horse battery staple') as Uint8List);
    ...
    test('can generate a Testnet address', () {
      ...
      final address =
          P2PKH(data: PaymentData(pubkey: keyPair.publicKey), network: testnet).data.address;
    ...
    test('can generate a Litecoin address', () {
      ...
      final wif = keyPair.toWIF();
      final address =
          P2PKH(data: PaymentData(pubkey: keyPair.publicKey), network: litecoin).data.address;
    ...
    test('can generate a SegWit testnet address', () {
      ...
      final address =
          P2WPKH(data: PaymentData(pubkey: keyPair.publicKey), network: testnet).data.address;

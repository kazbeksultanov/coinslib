...
main() {
  final aliceKey = ECPair.fromWIF('L1uyy5qTuGrVXrmrsvHWHgVzW9kKdrp27wBC7Vs6nZDTF2BRUVwy');
  ...
  group('bitcoinjs-lib (transactions)', () {
    ...
    test('can create (and broadcast via 3PBP) a Transaction, w/ a P2WPKH input', () {
      ...
      txb.addOutput('tb1qchsmnkk5c8wsjg8vxecmsntynpmkxme0yvh2yt', BigInt.from(1000000));
      txb.addOutput('tb1qn40fftdp6z2lvzmsz4s0gyks3gq86y2e8svgap', BigInt.from(8995000));
    ...
    test('can create a P2WSH output', () {
      ...
      txb.addInput('61d520ccb74288c96bc1a2b20ea1c0d5a704776dd0164a396efec3ea7040349d', 0);
      txb.addOutput(
          'bc1qqqqsyqcyq5rqwzqfpg9scrgwpugpzysnzs23v9ccrydpk8qarc0szrtjt7', BigInt.from(1000));
      txb.sign(vin: 0, keyPair: aliceKey);
